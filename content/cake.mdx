...
<table>
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>Enable the Rounded-Up Savings feature</td>
      <td>1 min</td>
    </tr>
    <tr>
      <td>2</td>
      <td>Set custom round-up amount to ₫10,000</td>
      <td>1 min 30s</td>
    </tr>
    <tr>
      <td>3</td>
      <td>View accumulated savings on the dashboard</td>
      <td>45s</td>
    </tr>
    <tr>
      <td>4</td>
      <td>Modify saving settings</td>
      <td>1 min 15s</td>
    </tr>
    <tr>
      <td>5</td>
      <td>Disable and re-enable the feature</td>
      <td>1 min</td>
    </tr>
  </tbody>
</table>
