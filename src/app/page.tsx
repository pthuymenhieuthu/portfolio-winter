          ...
          {DATA.certifications.map((certifications, id) => (
            ...
            >
              <ResumeCard
                ...
                altText={certifications.name}
                title={certifications.name}
                subtitle={certifications.org}
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Find out more on my <a href="https://www.behance.net/thuynguyen175" target="_blank" rel="noopener noreferrer" className="underline">Behance</a>
                </p>
              </div>
            </div>
          </BlurFade>
