...
export function EdTechCaseStudy() {
  return (
    <main className="min-h-screen font-sans text-[#092014]" style={{ backgroundColor: theme.page }}>
      ...
      <section className="relative z-10 mx-auto flex w-full max-w-[934px] flex-col gap-28 px-5 py-24 before:absolute before:inset-x-[-50vw] before:inset-y-0 before:-z-10 before:bg-[#f7fff3] sm:gap-32 sm:px-8 lg:gap-36 lg:py-36">
