        ...
        {!isMobile ? (
          <BlurFade delay={BLUR_FADE_DELAY}>
            ...
            >
              <span
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-3 bottom-0 z-0 h-px bg-gradient-to-r from-transparent via-[#3BA0FF]/80 to-transparent opacity-0 shadow-[0_0_5px_rgba(59,160,255,.32)] transition-opacity duration-500 group-hover:opacity-100"
              />
