...
const qrScreens: FlowScreen[] = [
  {
    ...
    label: "11 · Scan QR",
    detail: "Camera viewport with guide frame, flash control and manual fallback.",
    width: 390,
    height: 859,
  },
  {
    ...
    detail: "Enter the product-pack serial with a visual location guide.",
    width: 430,
    height: 875,
  },
  {
    ...
    label: "13 · Processing",
    detail: "Block interaction while verifying, then move automatically to the result.",
    width: 390,
    height: 859,
  },
  {
    ...
    detail: "Show product, QR and reward details with actions to continue.",
    width: 430,
    height: 871,
  },
];
...
const accountScreen: FlowScreen = {
  ...
  label: "26 · Account",
  detail: "Profile, security, bank, notification and support settings.",
  width: 390,
  height: 1239,
};
...
const bankScreens: FlowScreen[] = [
  {
    ...
    label: "27 · No bank account",
    detail: "Explain the linking benefits and prompt users to add a bank account.",
    width: 390,
    height: 844,
  },
  {
    ...
    label: "28 · Bank linked",
    detail: "Show masked account details, verification status and account actions.",
    width: 390,
    height: 844,
  },
];
