...
function AffinaStickyIndicator() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-40 bg-transparent">
      <div
        className={cn(
          "pointer-events-auto flex h-8 w-full items-center justify-center rounded-b-[999px] bg-black px-4 text-[13px] tracking-normal text-[#f7eaff] transition-transform duration-500 ease-out sm:text-sm",
    ...
    <main className="min-h-screen bg-[#f9f4ff] font-[var(--font-affina-body)] text-[#08090a]">
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex max-w-[560px] flex-col items-center gap-5">
          ...
          <h1 className="font-[var(--font-affina-heading)] text-[48px] font-bold leading-[1.05] tracking-normal sm:text-[64px]">
            Affina
          </h1>
          <p className="text-base leading-[1.35] text-white">
            ...
            <span className="text-white/75">
              · Scalable design system and AI-enhanced workflow
            </span>
          </p>
        </div>
      </section>
